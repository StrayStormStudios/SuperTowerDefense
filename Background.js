...
Background.drawAll = function(ctxBackgroundImage, ctxUIStatic, ctxUIDynamic, backgroundImage,
 mouseX, mouseY) {	
...
Background.drawScreenCoverStatic = function(ctx){
	...
	*/
    ...
    grd = ctx.createLinearGradient(150.000, 20, 150.000, Background.HEIGHT+ 10);
    grd.addColorStop(0.000, 'rgba(80, 80, 80, 1.000)');
    grd.addColorStop(0.020, 'rgba(51, 51, 51, 1.000)');
    grd.addColorStop(0.950, 'rgba(51, 51, 51, 1.000)');
    grd.addColorStop(1.000, 'rgba(60, 60, 60, 1.000)');
	
	grd2 = ctx.createLinearGradient(0, 150.000, Background.WIDTH, 150.000);
    grd2.addColorStop(0.000, 'rgba(80, 80, 80, 1.000)');
    grd2.addColorStop(0.018, 'rgba(51, 51, 51, 1.000)');
    grd2.addColorStop(0.965, 'rgba(51, 51, 51, 1.000)');
    grd2.addColorStop(1.000, 'rgba(60, 60, 60, 1.000)');
	  
	Background.drawScreen(ctx, 0, 20, Background.WIDTH-10, Background.HEIGHT-20, Background.SCREEN_X,
		Background.SCREEN_Y,Background.SCREEN_WIDTH,Background.SCREEN_HEIGHT, 20, true, false, grd, grd2);
    
	//Inner border of Screen	
	grd = ctx.createLinearGradient(150.000, Background.SCREEN_Y - 10, 150.000, Background.SCREEN_HEIGHT + Background.SCREEN_Y + 10);
    grd.addColorStop(0.000, 'rgba(51, 51, 51, 1.000)');
    grd.addColorStop(0.010, 'rgba(41, 41, 41, 1.000)');
    grd.addColorStop(0.976, 'rgba(51, 51, 51, 1.000)');
    grd.addColorStop(1.000, 'rgba(70, 70, 70, 1.000)');
	
	grd2 = ctx.createLinearGradient(Background.SCREEN_X-10, 150.0, Background.SCREEN_WIDTH+Background.SCREEN_X+8, 150.0);
	grd2.addColorStop(0.000, 'rgba(51, 51, 51, 1.000)');
    grd2.addColorStop(0.010, 'rgba(41, 41, 41, 1.000)');
    grd2.addColorStop(0.976, 'rgba(51, 51, 51, 1.000)');
    grd2.addColorStop(1.000, 'rgba(70, 70, 70, 1.000)');
	
	Background.drawScreen(ctx,Background.SCREEN_X - 10, Background.SCREEN_Y- 10,Background.SCREEN_WIDTH+18,Background.SCREEN_HEIGHT+18,
  	  Background.SCREEN_X,Background.SCREEN_Y,Background.SCREEN_WIDTH,Background.SCREEN_HEIGHT, 20, true, false, grd, grd2);
...
Background.drawStageStatic = function(ctx){
	...
	*/
	...
	ctx.closePath();
	// Create gradient
    grd = ctx.createRadialGradient(Background.WIDTH-110,40, 0.000, Background.WIDTH-110,40, 138.000);
	...
	// Create gradient
    grd = ctx.createRadialGradient(Background.WIDTH-38,96, 0.000, Background.WIDTH-38,96, 117.000);
    grd.addColorStop(0.015, 'rgba(90, 90, 90, 1.000)');
    grd.addColorStop(0.199, 'rgba(81, 81, 81, 1.000)');
    grd.addColorStop(0.937, 'rgba(41, 41, 41, 1.000)');
    grd.addColorStop(1.000, 'rgba(70, 70, 70, 1.000)');
...
Background.drawUpgradeTowerMenuDynamic = function(ctx){
	...
	if(selectedTower != null){
		...
		if(type == 1){
			TowerDrawing.draw1(ctx,  891, 458, .75, .75, rotation, 
				true, false, color1, color2, color3, color4, highlightColor);
		} else if(type == 2){
			TowerDrawing.draw2(ctx,  891, 458, .75, .75, rotation, 
				true, false, color1, color2, color3, color4, highlightColor);
		} else if(type == 3){
			TowerDrawing.draw3(ctx,  891, 458, .75, .75, rotation, 
				true, false, color1, color2, color3, color4, highlightColor);
		} else if(type == 4){
			TowerDrawing.draw4(ctx,  891, 458, .75, .75, rotation, 
				true, false, color1, color2, color3, color4, highlightColor);
		} else if(type == 5){
			TowerDrawing.draw5(ctx,  891, 458, .75, .75, rotation, 
				true, false, color1, color2, color3, color4, highlightColor);
		} else if(type == 6){
			TowerDrawing.draw6(ctx,  891, 458, .75, .75, rotation, 
				true, false, color1, color2, color3, color4, highlightColor);
		}
	}
	if(selectedTower!=null){
 ...
 * @param {Boolean} [stroke = true] Whether to stroke the rectangle.
 */
Background.drawScreen = function(ctx, x, y, width, height, x2, y2, 
	width2, height2, radius, fill, stroke, grd, grd2) {
  if (typeof stroke == 'undefined') {
    stroke = true;
  }
  if (typeof radius === 'undefined') {
...
Background.setBorderGradient = function(ctx, x, y, width, height, indented){
	ctx.fillStyle = "#222222";
	Background.grd = ctx.createLinearGradient(150.000, y, 150.000, y+height);
	Background.grd2 = ctx.createLinearGradient(x, 150.00, x+width, 150.00);
	
	//set gradients based on size
	if(!indented){
		Background.grd.addColorStop(0.000, 'rgba(85, 85, 85, 1.000)');
		Background.grd.addColorStop(0.05, 'rgba(61, 61, 61, 1.000)');
		Background.grd.addColorStop(0.95, 'rgba(61, 61, 61, 1.000)');
		Background.grd.addColorStop(1.000, 'rgba(41, 41, 41, 1.000)');
		
		Background.grd2.addColorStop(0.000, 'rgba(85, 85, 85, 1.000)');
		Background.grd2.addColorStop(0.05, 'rgba(61, 61, 61, 1.000)');
		Background.grd2.addColorStop(0.95, 'rgba(61, 61, 61, 1.000)');
		Background.grd2.addColorStop(1.000, 'rgba(41, 41, 41, 1.000)');
	} else {
		Background.grd.addColorStop(0.000, 'rgba(41, 41, 41, 1.000)');
		Background.grd.addColorStop(0.05, 'rgba(61, 61, 61, 1.000)');
		Background.grd.addColorStop(0.95, 'rgba(61, 61, 61, 1.000)');
		Background.grd.addColorStop(1.000, 'rgba(85, 85, 85, 1.000)');

		Background.grd2.addColorStop(0.000, 'rgba(41, 41, 41, 1.000)');
		Background.grd2.addColorStop(0.05, 'rgba(61, 61, 61, 1.000)');
		Background.grd2.addColorStop(0.95, 'rgba(61, 61, 61, 1.000)');
		Background.grd2.addColorStop(1.000, 'rgba(85, 85, 85, 1.000)');
	}
}
...
Background.setGreenGradient = function(ctx, x, y, width, height, isDisabled, isHighlighted){
	...
	Background.grd = ctx.createLinearGradient(150.000, y, 150.000, y+height);
	if(isDisabled){
		Background.grd.addColorStop(0.000, 'rgba(65, 65, 65, 1.00)');
		Background.grd.addColorStop(0.500, 'rgba(80, 80, 80, 1.00)');
		Background.grd.addColorStop(1.000, 'rgba(65, 65, 65, 1.00)');
	} else if(isHighlighted) {
		Background.grd.addColorStop(0.000, 'rgba(0, 130, 0, 1.00)');
		Background.grd.addColorStop(0.500, 'rgba(15, 160, 0, 1.00)');
		Background.grd.addColorStop(1.000, 'rgba(0, 130, 0, 1.00)');
	} else {
		Background.grd.addColorStop(0.000, 'rgba(5, 65, 0, 1.00)');
		Background.grd.addColorStop(0.500, 'rgba(7, 80, 0, 1.00)');
		Background.grd.addColorStop(1.000, 'rgba(5, 65, 0, 1.00)');
	}
}

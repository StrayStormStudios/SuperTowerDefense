...
Background.drawUpgradeTowerMenuDynamic = function (ctx) {
  ...
  if (selectedTower != null) {
    ...
    if (selectedTower.currentUpgradeOne >= selectedTower.upgradesOne.length) {
      ...
      var curUpgrade =
        selectedTower.upgradesOne[selectedTower.currentUpgradeOne];
      ...
      if (curUpgrade.cost < SuperTower.cash) {
        firstDisabled = false;
        if (SuperTower.towerMenu.upgradeHighlighted == 1)
    ...
    if (selectedTower.currentUpgradeTwo >= selectedTower.upgradesTwo.length) {
      ...
      //read in the current upgrade
      var curUpgrade =
        selectedTower.upgradesTwo[selectedTower.currentUpgradeTwo];
      ...
      if (curUpgrade.cost < SuperTower.cash) {
        ...
        if (SuperTower.towerMenu.upgradeHighlighted == 2)
  ...
  for (var i = SuperTower.towers.towers.length - 1; i >= 0; i--) {
    ...
    //selected
      ...
      Background.drawText(
        ...
        1182,
        187,
        "Armor Damage: " + isSelected.armorDamage,
        12,
        false,
        true
      );
      ...
      Background.drawText(
        ...
        1182,
        267,
        "Speed: " + isSelected.framesPerShot,
        15,
        false,
        true
      );

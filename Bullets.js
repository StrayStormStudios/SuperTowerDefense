...
*/
Bullets.prototype.add = function (position, rotation, targetEnemy, targetFrame, speed, drawingType, radius, color) {
  var bullet = new Bullet(position, rotation, targetEnemy, targetFrame, speed, drawingType, radius, color);

...
function draw(ctx) {
	...
	EnemyDrawing.draw1(ctx, 100, 100, 0, 30, "#cc0000", "#000000", "#00ff00", "#000000");
	EnemyDrawing.draw2(ctx, 200, 100, 0, 30, "#9d2ade", "#000000", "#0000cc", "#000000");
	EnemyDrawing.draw3(ctx, 300, 100, 0, 30, "#aaaaaa", "#000000", "#0000cc", "#000000");
	EnemyDrawing.draw4(ctx, 400, 100, 0, 30, "#0000cc", "#800000", "#00cc00", "#cc0000");
	EnemyDrawing.draw5(ctx, 500, 100, 0, 30, "#e0be1a", "#000000", "#0000cc", "#000000");
	EnemyDrawing.draw6(ctx, 100, 300, 0, 30, "#00CC00", "#000000", "#0000cc", "#000000");
	EnemyDrawing.draw7(ctx, 200, 300, 0, 30, "#9d2ade", "#000000", "#0000cc", "#cc0000");
	EnemyDrawing.draw8(ctx, 300, 300, 0, 30, "#00CC00", "#000000", "#0000cc", "#000000");
	EnemyDrawing.draw9(ctx, 400, 300, 0, 30, "#af0038", "#000000", "#ff0000", "#0000cc");
	EnemyDrawing.draw10(ctx, 500, 300, 0, 30, "#00CC00", "#000000", "#0000cc", "#cc0000");

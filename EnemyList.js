...
//Fast enemies that gradually get faster and stronger
	...
	//Fast Enemy that has 1500 health, 200 armor, 65.0 speed, 50 damage, and may split
		...
		return EnemyList.createLightSpeedEnemy(type, frame, path, distanceTravelled);
	}
...
EnemyList.createBasicEnemy = function(type, frame, path, distanceTravelled){
	...
	var curEnemy = new Enemy(type, health, armor, money, speed, damage,
...
* @return {Enemy} The enemy created
*/
EnemyList.createDifficultEnemy = function(type, frame, path, distanceTravelled){
	var health = 700;
	var armor = 200;
	var money = 10;
	var speed = 1.5;
...
* @return {Enemy} The enemy created
*/
EnemyList.createLightingEnemy = function(type, frame, path, distanceTravelled){
	var health = 800;
	var armor = 0;
	var money = 25;
	var speed = 8.5;
...
* @return {Enemy} The enemy created
*/
EnemyList.createLightSpeedEnemy = function(type, frame, path, distanceTravelled){
	var health = 1500;
	var armor = 200;
	var money = 50;
	var speed = 12.5;
...
* @return {Enemy} The enemy created
*/
EnemyList.createSheildedEnemy = function(type, frame, path, distanceTravelled){
	var health = 550;
	var armor = 600;
	var money = 25;
	var speed = 0.8;
...
* @return {Enemy} The enemy created
*/
EnemyList.createBarrieredEnemy = function(type, frame, path, distanceTravelled){
	var health = 700;
	var armor = 700;
	var money = 35;
	var speed = 0.7;

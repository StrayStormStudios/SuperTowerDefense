...
TowerType.createTower1 = function(position, rotation, upgraded){
	...
	upgradesTwo.push(new TowerUpgrade("explosionDamage", "Blast Damage+", 75, 25));
	upgradesTwo.push(new TowerUpgrade("explosionRadius", "Blast Radius++", 100, 5));
	upgradesTwo.push(new TowerUpgrade("explosionDamage", "Blast Damage++", 125, 50));
	...
	var explosionInitialAlpha = .9;
	var explosionFullSizeAlpha = .6;
	var explosionFadeFrames = 5;
	var explosionFinalAlpha = .2;
	...
	var tower = new Tower(position, rotation,
...
TowerType.createTower3 = function(position, rotation){
	...
	upgradesOne.push(new TowerUpgrade("buffArmorDamage", "Buff A. Dam.+", 300, 50));
	upgradesOne.push(new TowerUpgrade("buffDamage", "Buff Damage++", 500, 100));
	upgradesOne.push(new TowerUpgrade("buffArmorDamage", "Buff A. Dam.++", 750, 100));
	var upgradesTwo = new Array();
...
TowerType.createTower4 = function(position, rotation){
	...
	upgradesTwo.push(new TowerUpgrade("explosionRadius", "Explosion Rdius++", 250, 5));
...
TowerType.createTower5 = function(position, rotation){
	...
	upgradesTwo.push(new TowerUpgrade("framesPerShot", "Speed+", 150, 2));
	upgradesTwo.push(new TowerUpgrade("range", "Range++", 200, 25));
	upgradesTwo.push(new TowerUpgrade("explosionRadius", "exploding Bullets++", 250, 20));
...
TowerType.createTower6 = function(position, rotation){
	...
	upgradesOne.push(new TowerUpgrade("damage", "Damage+", 50, 100));
	upgradesOne.push(new TowerUpgrade("armorDamage", "Armor Damage+", 100, 100));
	upgradesOne.push(new TowerUpgrade("explosionDamage", "Explosion Damage+", 150, 50));
	upgradesOne.push(new TowerUpgrade("armorDamage", "Armor Damage++", 200, 20));
	var upgradesTwo = new Array();
	upgradesTwo.push(new TowerUpgrade("range", "Range+", 100, 50));
	upgradesTwo.push(new TowerUpgrade("framesPerShot", "Speed+", 150, 2));
	upgradesTwo.push(new TowerUpgrade("range", "Range++", 200, 25));
	upgradesTwo.push(new TowerUpgrade("explosionRadius", "Explosion Rdius++", 250, 20));
